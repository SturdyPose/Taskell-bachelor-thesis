...
\textbf{Haskell}
\begin{minted}[bgcolor=CodeBackGround]{haskell}
loadModels:: IO [Float -> Model]
loadModels scaleFactor = 
    let _loadModel1 = \x1 -> ((scale x1) . (rotate 0.0 45.0 90.0)) loadModel1 in 
    let _loadModel2 = \x2 -> ((scale x2) . (rotate 0.0 45.0 90.0)) loadModel2 in 
      runListConcurrently [_loadModel1, _loadModel2] 
\end{minted}
...
rozparsovat a 
poté je vyrenderovat na hlavním vlákně.
