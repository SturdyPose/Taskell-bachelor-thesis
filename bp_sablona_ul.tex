...
tak tok dat je vždy nedeterministický.

Vezmeme si scénář z reálného života, 
...
zbylé dva členové domácnosti musí nakoupit.
...
která se okořenila a dala do trouby.
...
proč je nepoužít?
Samozřejmě se uvnitř počítače nenachází lidé, 
ale moderní procesor s mnoha jádry.
V kontextu konkurence a paralelismu existují dva způsoby 
jak tomu předejít a to jsou semafor a mutex.




Pro návrh DSL je hlavní vědět o jakou doménu problematiky se jedná.
Totiž zatím neexistuje žádná DSL implementace pro konkurenci a
